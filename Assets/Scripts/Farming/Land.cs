...
public class Land : MonoBehaviour, ITimeTracker
{
    ...
    public void Interact()
    {
        ...
        ItemData toolSlot = InventoryManager.Instance.GetEquippedSlotItem(InventorySlots.InventoryType.Tool);

        //If there's nothing equipped, return
        if (!InventoryManager.Instance.SlotEquipped(InventorySlots.InventoryType.Tool))
        {
            return;
        }
        ...
        if (seedTool != null && landStatus != LandStatus.Soil && cropPlanted == null)
        {
            ...
            //Consume the item
            InventoryManager.Instance.ConsumeItem(InventoryManager.Instance.GetEquippedSlot(InventorySlots.InventoryType.Tool));
