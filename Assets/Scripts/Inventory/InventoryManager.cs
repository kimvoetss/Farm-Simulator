...
public class InventoryManager : MonoBehaviour
{
    ...
    public void InventoryToHand(int slotIndex, InventorySlots.InventoryType inventoryType)
    {
        ...
        if (inventoryType == InventorySlots.InventoryType.Item)
        {
    ...
    public void HandToInventory(InventorySlots.InventoryType inventoryType)
    {
    ...
    public void RenderHand()
    {
        ...
        if (SlotEquipped(InventorySlots.InventoryType.Item))
        {
            //Instantiate the game model on the player's hand and put it on the scene
            Instantiate(GetEquippedSlotItem(InventorySlots.InventoryType.Item).gameModel, handPoint);
        }
    ...
    public ItemData GetEquippedSlotItem(InventorySlots.InventoryType inventoryType)
    {
        if (inventoryType == InventorySlots.InventoryType.Item)
        {
    ...
    public ItemSlotData GetEquippedSlot(InventorySlots.InventoryType inventoryType)
    {
        if (inventoryType == InventorySlots.InventoryType.Item)
        {
    ...
    public ItemSlotData[] GetInventorySlots(InventorySlots.InventoryType inventoryType)
    {
        if (inventoryType == InventorySlots.InventoryType.Item)
        {
            return itemSlots;
    ...
    public bool SlotEquipped(InventorySlots.InventoryType inventoryType)
    {
        if (inventoryType == InventorySlots.InventoryType.Item)
        {
